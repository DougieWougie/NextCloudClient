    ...
    Scaffold(
        topBar = {
            AppTopBar(
                ...
                actions = {
                    IconButton(onClick = { viewModel.onEvent(SettingsEvent.SaveClicked) }) {
                        Icon(
                            imageVector = Icons.Default.Save,
                            contentDescription = "Save changes"
                        )
                    }
                    IconButton(onClick = { viewModel.onEvent(SettingsEvent.LogoutClicked) }) {
                        Icon(
                ...
                Card(
                    ...
                    Row(
                        ...
                        Column(modifier = Modifier.weight(1f)) {
                            ...
                            Text(
                                text = "Show files and folders starting with '.' and user email directories",
                        ...
                        Switch(
                            ...
                            onCheckedChange = { viewModel.onEvent(SettingsEvent.ShowHiddenFilesToggled(it)) }
                        )
                    }
                }
