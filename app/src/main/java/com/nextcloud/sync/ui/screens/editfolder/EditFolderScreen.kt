...
fun EditFolderScreen(
    ...
    if (uiState.errorMessage != null) {
        ErrorDialog(
            ...
            onDismiss = { viewModel.onEvent(EditFolderEvent.MessageDismissed) }
        )
    }
    ...
    Scaffold(
        ...
        if (uiState.isLoading) {
            ...
            Column(
                ...
                // Local Folder Section (Read-only)
                Text(
                    text = "Local Folder",
                ...
                Card(
                    ...
                    Row(
                        ...
                        Column(modifier = Modifier.weight(1f)) {
                            ...
                            if (uiState.localFolderPath.isNotEmpty()) {
                                Text(
                                    text = uiState.localFolderPath,
                                    style = MaterialTheme.typography.bodySmall,
                                    color = MaterialTheme.colorScheme.onSurfaceVariant
                                )
                            }
                    ...
                    Column(modifier = Modifier.padding(16.dp)) {
                        ...
                        Row(
                            ...
                            Switch(
                                ...
                                onCheckedChange = {
                                    viewModel.onEvent(EditFolderEvent.TwoWaySyncChanged(it))
                                }
                            )
                        }
                        ...
                        Row(
                            ...
                            Switch(
                                ...
                                onCheckedChange = {
                                    viewModel.onEvent(EditFolderEvent.WifiOnlyChanged(it))
                                }
                            )
                        }
                    }
